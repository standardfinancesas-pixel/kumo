...
import { data, urls, waLink, INSTAGRAM, EMPRESA, APP_STORE, PLAY_STORE } from '@kumo/shared';
      ...
      <div className="r-grid2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, alignItems: 'stretch' }}>
        <div className="r-banner" style={{ background: 'rgb(93,84,145)', borderRadius: 28, padding: '48px 44px', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', position: 'relative' }}>
            {/* Las dos tiendas. La de Google Play sale de `PLAY_STORE`, que hoy es
                null porque la ficha no existe todavía: mientras tanto cae en la
                webapp. Cuando salga se cambia en shared y este botón la toma. */}
            ...
            <a href={PLAY_STORE ?? WEBAPP} target={PLAY_STORE ? '_blank' : undefined} rel={PLAY_STORE ? 'noopener noreferrer' : undefined} className="scph" style={{ display: 'flex', alignItems: 'center', gap: 11, background: 'rgb(33,30,51)', color: '#fff', borderRadius: 14, padding: '10px 18px', textDecoration: 'none', transition: 'background 0.15s' }}>
